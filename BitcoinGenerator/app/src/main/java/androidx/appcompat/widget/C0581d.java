...
public class C0581d extends android.widget.AutoCompleteTextView implements p000a.p018g.p029l.AbstractC0215q {

    /* renamed from: d */
    private static final int[] f2070d = null;

    /* renamed from: b */
    private final androidx.appcompat.widget.C0585e f2071b;

    /* renamed from: c */
    private final androidx.appcompat.widget.C0655x f2072c;
    ...
    static {
            ...
            r0[r1] = r2
            androidx.appcompat.widget.C0581d.f2070d = r0
            return
    }

    public C0581d(android.content.Context r2) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r0)
            return
    ...
    public C0581d(android.content.Context r2, android.util.AttributeSet r3) {
            r1 = this;
    ...
    public C0581d(android.content.Context r3, android.util.AttributeSet r4, int r5) {
            r2 = this;
            android.content.Context r3 = androidx.appcompat.widget.C0632q0.m1914b(r3)
            r2.<init>(r3, r4, r5)
            android.content.Context r3 = r2.getContext()
            int[] r0 = androidx.appcompat.widget.C0581d.f2070d
            r1 = 0
        ...
        L_0x001f:
            ...
            r3.<init>(r2)
            r2.f2071b = r3
            androidx.appcompat.widget.e r3 = r2.f2071b
            r3.m2084a(r4, r5)
            androidx.appcompat.widget.x r3 = new androidx.appcompat.widget.x
            r3.<init>(r2)
            r2.f2072c = r3
            androidx.appcompat.widget.x r3 = r2.f2072c
            r3.m1814a(r4, r5)
            androidx.appcompat.widget.x r3 = r2.f2072c
            r3.m1822a()
            return
    ...
    protected void drawableStateChanged() {
            ...
            androidx.appcompat.widget.e r0 = r1.f2071b
            if (r0 == 0) goto L_0x000a
            r0.m2089a()
        L_0x000a:
            androidx.appcompat.widget.x r0 = r1.f2072c
